...
public partial class ScrollFeedGameView : UserControl
{
    ...
    protected override void OnLoaded(global::Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        if (DataContext is ScrollFeedGameViewModel vm)
        {
    ...
    {
        if (_feedScrollViewer == null || DataContext is not ScrollFeedGameViewModel vm)
            return;
    ...
    private void OnGameInputChanged(object? sender, GameInputEventArgs e)
    {
        ...
        {
            if (DataContext is not ScrollFeedGameViewModel vm) return;
