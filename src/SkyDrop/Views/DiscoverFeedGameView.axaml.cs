...
public partial class DiscoverFeedGameView : UserControl
{
    ...
    {
        if (DataContext is DiscoverFeedGameViewModel vm)
        {
    ...
    private void OnGameInputChanged(object? sender, GameInputEventArgs e)
    {
        ...
        {
            if (DataContext is not DiscoverFeedGameViewModel vm) return;
